...
public class ZB_MouseSlide : MonoBehaviour {
    ...
    void GetMouseY()
    {
        ...
        {
            case Axis.X:
                transform.Translate(new Vector3(yInput, 0f, 0f), Space.World);
                break;
            case Axis.Y:
                transform.Translate(new Vector3(0f, yInput, 0f), Space.World);
                break;
            case Axis.Z:
                transform.Translate(new Vector3(0f, 0f, yInput), Space.World);
                break;
            case Axis.None:
                break;
        }
